...
\item In der zweiten Phase, dem \textit{PreAnalyzerTransformer}, werden Manipulationen am Syntaxbaum durchgeführt. Dabei werden verschiedene VHDL 2008 Abstract Syntax Tree (AST)-Knoten in VHDL-2002 Knoten umgewandelt um die folgenden Phasen zu vereinfachen. Durch diese Umwandlung werden diese Knoten aus dem Baum entfernt und müssen daher nicht behandelt werden.
...
\lstset{caption={Logical Expression}}
...
\lstset{caption={Konstanten Deklaration}}
