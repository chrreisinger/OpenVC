\chapter{Architektur}
{\em 
In diese Kapitel wird die Architektur erklärt, dynamische sowie statische. Es wird dabei erklärt wie VHDL Source Code verarbeitet wird.
}
...
In der Beschreibung von Coco/R [Möss03] werden drei verschiedene Möglichkeiten erörtert, wie diese Konflikte gelöst werden können. Mit Hilfe dieser drei Varianten ist es auch gelungen, die Grammatik in eine für Coco/R valide LL(1) Form umzuwandeln. Die drei Ansätze zur Behebung der Konflikte werden nachstehend erörtert.
