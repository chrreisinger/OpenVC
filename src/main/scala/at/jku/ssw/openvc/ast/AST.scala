...
/**
 * Represents a concurrent procedure call statement, which is similar to a sequential procedure call statement
 *
...
/**
 * Represents a concurrent assertion statement, which is similar to a sequential assert statement
 *
